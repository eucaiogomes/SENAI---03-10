...
public class FiltroConfig {
    ...
    public FilterRegistrationBean<FiltroAutenticacao> filtroAutenticacao() {
        ...
        registration.addUrlPatterns("/", "/usuariolista", "/usuariocadastro", "/usuarioatualizar/*", "/usuarioexcluir/*",
                                    "/recursolista", "/recursocadastro", "/recursoatualizar/*", "/recursoexcluir/*",
                                    "/reservalista", "/reservacadastro", "/reservacancelar/*");
